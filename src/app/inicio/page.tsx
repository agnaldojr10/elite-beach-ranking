...
import { LiveMatchCard, StatusChip } from "@/components/player/ui";
  ...
  return (
    <PlayerShell>
      ...
      <div className="flex flex-col gap-3.5">
        ...
        {home.proxima && (
          <Link
            href={`/rodada?r=${home.proxima.id}`}
            className="flex items-center gap-3 rounded-[22px] border border-line bg-card p-4"
          >
